        ...
        openNode(file, "job");
            ...
            for (var i = 0; i < layoutNodes.length; i++) {
                ...
                openNode(file, "layout");
                    ...
                    /*
                    openNode(file, "templates");
                        openNode(file, "template");
                            writeElement(file, "name", node.evalToString('//templates/template/name'));
                            writeElement(file, "source", node.evalToString('//templates/template/source'));
                            writeElement(file, "items", node.evalToString('//templates/template/items'));
                            writeElement(file, "placed", node.evalToString('//templates/template/placed'));
                        closeNode(file, "/template");
                    closeNode(file, "/templates");
                    */
